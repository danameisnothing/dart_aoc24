...
void execD5P2() {
  final input = File("lib/solutions/dayfive/parttwo/input.txt").readAsLinesSync();
  ...
  final correctedNumbers = <List<String>>[];
  ...
  for (String e in pageNumbersSection) {
    ...
    if (ListEquality().equals(sortedNumberKey, pageNumbers) == false) correctedNumbers.add(sortedNumberKey);
  }

  int total = 0;

  for (final numbers in correctedNumbers) {
